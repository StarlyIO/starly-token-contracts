...
function transferVestings({to, from, vestingIds, addressMap}) {
    return tx("../../../transactions/vesting/transfer_vesting_nfts.cdc", [vestingIds, to], from, addressMap);
}

function setupVestingCollection({signer, addressMap}) {
    return tx("../../../transactions/vesting/setup_account.cdc", [], signer, addressMap);
}

function adminBurnVesting({signer, id, addressMap}) {
    return tx("../../../transactions/vesting/admin/burn.cdc", [id], signer, addressMap);
}

function adminVestLinear({signer, beneficiary, amount, durationSeconds, addressMap}) {
    return tx("../../../transactions/vesting/admin/vest_linear.cdc", [beneficiary, amount, durationSeconds], signer, addressMap);
}

function adminVestPeriod({signer, beneficiary, amount, tenPercentDuration, addressMap}) {
    return tx("../../../transactions/vesting/admin/vest_period.cdc", [beneficiary, amount, tenPercentDuration], signer, addressMap);
}

function release({signer, id, addressMap}) {
    return tx("../../../transactions/vesting/release.cdc", [id], signer, addressMap);
}

function tamperVestedVault({signer, addressMap}) {
    return tx("../../../transactions/vesting/tamper_vested_vault.cdc", [], signer, addressMap);
}

function tamperVestingSchedule({signer, addressMap}) {
    return tx("../../../transactions/vesting/tamper_vesting_schedule.cdc", [], signer, addressMap);
}
...
function burnVesting({signer, k, addressMap}) {
    return tx("../../../transactions/vesting/burn_vesting.cdc", [], signer, addressMap);
}

function burnVestingCollection({signer, k, addressMap}) {
    return tx("../../../transactions/vesting/burn_vesting_collection.cdc", [], signer, addressMap);
}
...
async function getReleasableAmount(account, id, addressMap) {
    return await script("../../../scripts/vesting/read_releasable_amount.cdc", [account, id], addressMap)
}

async function getMetadata(account, id, addressMap) {
    return await script("../../../scripts/vesting/read_metadata.cdc", [account, id], addressMap)
}

async function getMetadataDisplay(account, id, addressMap) {
    return await script("../../../scripts/vesting/read_metadata_display.cdc", [account, id], addressMap)
}
